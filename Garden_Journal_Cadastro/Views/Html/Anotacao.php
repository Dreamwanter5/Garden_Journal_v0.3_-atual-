    ...
    <div class="container" v-scope="app" @vue:mounted="mounted">
        ...
        <form @submit.prevent="salvarNota" id="form-anotacao">
            <header>
                <!-- Campo de título -->
                <div class="mb-4">
                    <input type="text" name="titulo" v-model="formData.titulo" @blur="validarTitulo"
                ...
                <!-- Campo de descrição -->
                <div class="mb-4">
                    <input type="text" name="descricao" v-model="formData.descricao"
                        :class="{'is-invalid': errors.descricao}" class="form-control border-0"
                ...
                <div class="editor-wrapper">
                    ...
                    <div class="editor-content">
                        <textarea name="conteudo" id="editor" placeholder="# Comece a escrever seu Markdown aqui..."
                            v-model="formData.conteudo" @input="atualizarPreview" @blur="validarConteudo"
                ...
                <div class="tip-card">
                    ...
                    <p>
                        ...
                        <small style="font-size:0.6rem; display:block; color:#6c757d;">
                            No momento o código não suporta o formato original de inserção em MD, eis aqui uma
                            alternativa
                        </small>
